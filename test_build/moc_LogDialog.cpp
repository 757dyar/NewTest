...
QT_MOC_LITERAL(4, 26, 12), // "onlogMessage"
QT_MOC_LITERAL(5, 39, 21), // "on_LogDialog_finished"
QT_MOC_LITERAL(6, 61, 6) // "result"

    },
    "LogDialog\0logMessage\0\0msg\0onlogMessage\0"
    "on_LogDialog_finished\0result"
};
...
void LogDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LogDialog *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->logMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->onlogMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->on_LogDialog_finished((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LogDialog::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogDialog::logMessage)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LogDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_LogDialog.data,
    qt_meta_data_LogDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void LogDialog::logMessage(const QString & _t1)
{
